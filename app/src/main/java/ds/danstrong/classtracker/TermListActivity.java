...
public class TermListActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private boolean createSampleData() {
        Uri term1Uri = DataManager.insertTerm(this, "Spring 2019", "2019-01-01", "2019-06-30", 1);
        Uri term2Uri = DataManager.insertTerm(this, "Fall 2019", "2019-07-01", "2019-12-31", 0);
        Uri term3Uri = DataManager.insertTerm(this, "Spring 2020", "2020-01-01", "2020-06-30", 0);
        Uri term4Uri = DataManager.insertTerm(this, "Fall 2020", "2020-07-01", "2020-12-31", 0);
        Uri term5Uri = DataManager.insertTerm(this, "Spring 2021", "2021-01-01", "2021-06-30", 0);
        ...
        Uri ass1Uri = DataManager.insertAssessment(this, Long.parseLong(course1Uri.getLastPathSegment()), "GRN1", "First Assessment",
